    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          ...
          <li class="list-inline-item text-white h3 font-secondary nasted">Search Result for: <?php echo isset($_GET['key'])?$_GET['key']: '' ?></li>
        </ul>
...
<section class="section">
  <div class="container">
    <?php
        $post_per_page = 3;
        $status = "Published";
        $sql1 = "SELECT * FROM posts WHERE post_title LIKE :p_title AND post_status = :status ORDER BY post_id DESC";
